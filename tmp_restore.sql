-- 1) Deshabilitar TODOS los bloques existentes del usuario 24
UPDATE horario_usuario SET estado = false, updated_at = now()
WHERE usuario_id = 24;

-- 2) Insertar bloques ORIGINALES
...
-- 3) Deshabilitar las reuniones de prueba (Act 4 y Act 5)
UPDATE actividades SET estado = false WHERE usuario_id = 24 AND id IN (4, 5);
